using iButton_apP.Port;
using MonoSerialPort.Port;
using System;
using System.IO;
using System.Threading;
using System.Threading.Tasks;
using Handshake = iButton_apP.Port.Handshake;
using Parity = iButton_apP.Port.Parity;
using SerialErrorReceivedEventArgs = iButton_apP.Port.SerialErrorReceivedEventArgs;
using StopBits = iButton_apP.Port.StopBits;
        ...
        private bool Open()
        {
            ...
            try
            {
                ...
                _serialPort = new SerialPort
                {
                    ...
                    Parity = (Port.Parity)_defaultParity,
                    DataBits = _defaultDataBits,
                    StopBits = (Port.StopBits)_defaultStopBits,
                    Handshake = (Port.Handshake)_handshake,
